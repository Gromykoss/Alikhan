...
## Правило №0 — Автоматическое ведение AGENTS.md и CHRONOLOGY.md

**После каждого завершённого блока работ (багфикс, фича, архитектурное решение):**
1. Обнови `AGENTS.md` — добавь/измени правила, архитектуру, быстрые команды, контекст восстановления.
2. Добавь запись в `CHRONOLOGY.md` (в корне проекта): дата, что сделано, результаты, коммит.
3. Не жди команды пользователя — делай автоматически.
4. Не перечитывай AGENTS.md с нуля при каждом переключении — обновляй только изменившееся.
