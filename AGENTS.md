...
## Последняя сессия (01.07.2026) — контекст восстановления

### Что сделано
- ЕЖО 30.06.2026 (v2): реальные фото Общежития, заливка исправлена, планы заполнены
- SIM_DATE отключён (None), бот в реальном времени
- Защита фото: `SELECT before INSERT` в main_waha.py L214 — дубликаты не пройдут
- График: 8 этапов синхронизированы с PDF «ГРАФИК СМР.pdf»
- Удалён спам опросников из песочницы (32 сообщения)
- Шаблон ЕЖО обновлён (v2, 1.3 MB с фото)
